...
{\color{incolor}In [{\color{incolor}15}]:} \PY{n}{pyplot}\PY{p}{(}\PY{p}{)}
         \PY{n}{plot}\PY{p}{(}\PY{n}{rand}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}\PY{p}{,}\PY{n}{title}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{Test Title}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{n}{label}\PY{o}{=}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{First}\PY{l+s}{\PYZdq{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{Second}\PY{l+s}{\PYZdq{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{Third}\PY{l+s}{\PYZdq{}} \PY{l+s}{\PYZdq{}}\PY{l+s}{Fourth}\PY{l+s}{\PYZdq{}}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}15}]:} \PY{c}{\PYZsh{} initialize the attractor}
         ...
         \PY{n}{plt} \PY{o}{=} \PY{n}{path3d}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{xlim}\PY{o}{=}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{25}\PY{p}{,}\PY{l+m+mi}{25}\PY{p}{)}\PY{p}{,} \PY{n}{ylim}\PY{o}{=}\PY{p}{(}\PY{o}{\PYZhy{}}\PY{l+m+mi}{25}\PY{p}{,}\PY{l+m+mi}{25}\PY{p}{)}\PY{p}{,} \PY{n}{zlim}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,}\PY{l+m+mi}{50}\PY{p}{)}\PY{p}{,}
                         ...
                         \PY{n}{title} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Lorenz Attractor}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{marker} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{)}
         
         \PY{c}{\PYZsh{} build an animated gif, saving every 10th frame}
         \PY{p}{@}\PY{n}{gif} \PY{k}{for} \PY{n}{i}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{:}\PY{n}{n}
             \PY{n}{dx} \PY{o}{=} \PY{n}{σ}\PY{o}{*}\PY{p}{(}\PY{n}{y} \PY{o}{\PYZhy{}} \PY{n}{x}\PY{p}{)}     \PY{p}{;} \PY{n}{x} \PY{o}{+}\PY{o}{=} \PY{n}{dt} \PY{o}{*} \PY{n}{dx}
             \PY{n}{dy} \PY{o}{=} \PY{n}{x}\PY{o}{*}\PY{p}{(}\PY{n}{ρ} \PY{o}{\PYZhy{}} \PY{n}{z}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{n}{y} \PY{p}{;} \PY{n}{y} \PY{o}{+}\PY{o}{=} \PY{n}{dt} \PY{o}{*} \PY{n}{dy}
             \PY{n}{dz} \PY{o}{=} \PY{n}{x}\PY{o}{*}\PY{n}{y} \PY{o}{\PYZhy{}} \PY{n}{β}\PY{o}{*}\PY{n}{z}     \PY{p}{;} \PY{n}{z} \PY{o}{+}\PY{o}{=} \PY{n}{dt} \PY{o}{*} \PY{n}{dz}
...
Ecosystem!}
    ...
    \hypertarget{type-recipe-example}{%
...
{\color{incolor}In [{\color{incolor}24}]:} \PY{k}{using} \PY{n}{DifferentialEquations}
         ...
         \PY{p}{@}\PY{n}{show} \PY{n+nb}{typeof}\PY{p}{(}\PY{n}{sol}\PY{p}{)}
         \PY{n}{plot}\PY{p}{(}\PY{n}{sol}\PY{p}{,}\PY{n}{title}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{The Attributes Still Work}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
typeof(sol) = DifferentialEquations.ODESolution
    ...
    \hypertarget{plot-and-type-recipes-together}{%
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{k}{using} \PY{n}{RDatasets}\PY{p}{,} \PY{n}{StatPlots}\PY{p}{,} \PY{n}{Plots}
        \PY{n}{iris} \PY{o}{=} \PY{n}{dataset}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{datasets}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{iris}\PY{l+s}{\PYZdq{}}\PY{p}{)}
        \PY{n}{marginalhist}\PY{p}{(}\PY{n}{iris}\PY{p}{,} \PY{p}{:}\PY{n}{PetalLength}\PY{p}{,} \PY{p}{:}\PY{n}{PetalWidth}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{M} \PY{o}{=} \PY{n}{randn}\PY{p}{(}\PY{l+m+mi}{1000}\PY{p}{,}\PY{l+m+mi}{4}\PY{p}{)}
        \PY{n}{M}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]} \PY{o}{+}\PY{o}{=} \PY{l+m+mf}{0.8}\PY{n}{sqrt}\PY{p}{(}\PY{n}{abs}\PY{p}{(}\PY{n}{M}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{p}{)}\PY{p}{)} \PY{o}{\PYZhy{}} \PY{l+m+mf}{0.5}\PY{n}{M}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{+} \PY{l+m+mi}{5}
        \PY{n}{M}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{]} \PY{o}{\PYZhy{}}\PY{o}{=} \PY{l+m+mf}{0.7}\PY{n}{M}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}\PY{o}{.}\PY{o}{\PYZca{}}\PY{l+m+mi}{2} \PY{o}{+} \PY{l+m+mi}{2}
        \PY{n}{corrplot}\PY{p}{(}\PY{n}{M}\PY{p}{,} \PY{n}{label} \PY{o}{=} \PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{x}\PY{l+s+si}{\PYZdl{}i}\PY{l+s}{\PYZdq{}} \PY{k}{for} \PY{n}{i}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{:}\PY{l+m+mi}{4}\PY{p}{]}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{k}{import} \PY{n}{RDatasets}
         \PY{n}{pyplot}\PY{p}{(}\PY{p}{)}
         \PY{n}{singers} \PY{o}{=} \PY{n}{RDatasets}\PY{o}{.}\PY{n}{dataset}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{lattice}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{singer}\PY{l+s}{\PYZdq{}}\PY{p}{)}
         \PY{n}{violin}\PY{p}{(}\PY{n}{singers}\PY{p}{,}\PY{p}{:}\PY{n}{VoicePart}\PY{p}{,}\PY{p}{:}\PY{n}{Height}\PY{p}{,}\PY{n}{marker}\PY{o}{=}\PY{p}{(}\PY{l+m+mf}{0.2}\PY{p}{,}\PY{p}{:}\PY{n}{blue}\PY{p}{,}\PY{n}{stroke}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{)}\PY{p}{)}\PY{p}{)}
         \PY{n}{boxplot!}\PY{p}{(}\PY{n}{singers}\PY{p}{,}\PY{p}{:}\PY{n}{VoicePart}\PY{p}{,}\PY{p}{:}\PY{n}{Height}\PY{p}{,}\PY{n}{marker}\PY{o}{=}\PY{p}{(}\PY{l+m+mf}{0.3}\PY{p}{,}\PY{p}{:}\PY{n}{orange}\PY{p}{,}\PY{n}{stroke}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{)}
\end{Verbatim}

    \hypertarget{series-type}{%
...
data into backends.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n}{groupedbar}\PY{p}{(}\PY{n}{rand}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{n}{bar\PYZus{}position} \PY{o}{=} \PY{p}{:}\PY{n}{dodge}\PY{p}{,} \PY{n}{bar\PYZus{}width}\PY{o}{=}\PY{l+m+mf}{0.7}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{gr}\PY{p}{(}\PY{p}{)}
         \PY{n}{groupedbar}\PY{p}{(}\PY{n}{rand}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{3}\PY{p}{)}\PY{p}{,} \PY{n}{bar\PYZus{}position} \PY{o}{=} \PY{p}{:}\PY{n}{dodge}\PY{p}{,} \PY{n}{bar\PYZus{}width}\PY{o}{=}\PY{l+m+mf}{0.7}\PY{p}{)}
\end{Verbatim}

    \hypertarget{project-regression-plot}{%
