...
To see the difference, we only need to go as far as basic math.
    ...
    \hypertarget{arithmetic-in-julia}{%
...
\end{Verbatim}
    ...
    \hypertarget{type-stability-and-code-introspection}{%
...
\hypertarget{this-is-the-key-difference-between-julia-and-other-scripting-languages}{%
...
performance than other scripting languages.
    ...
    \hypertarget{core-idea-multiple-dispatch-type-stability-speed-readability}{%
...
design it to be Julia.
    ...
    \hypertarget{the-julia-benchmarks}{%
...
performance.}
    ...
    \hypertarget{small-expansion-of-the-idea-strict-typing}{%
...
handle them.
    ...
    \hypertarget{performance-as-optional}{%
...
best performance, it's nice to have this as an option.
    ...
    \hypertarget{checking-for-type-stability}{%
...
optimize.
    ...
    \hypertarget{dealing-with-necessary-type-instabilities}{%
...
having the generic abilities of a scripting language.
    ...
    \hypertarget{repl-globals-have-bad-performance}{%
