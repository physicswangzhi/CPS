...
\makeatother
    ...
    \hypertarget{more-details-on-arrays-and-matrices}{%
...
same as mapping.
    ...
    \hypertarget{in-depth-julia-1-special-broadcasting-syntax}{%
...
way.
    ...
    \hypertarget{vectors-matrices-and-linear-algebra}{%
...
indexing order and in the computer's internal representation.
    ...
    \hypertarget{in-depth-julia-2-views}{%
...
can be used without worrying about performance issues.
    ...
    \hypertarget{back-to-linear-algebra}{%
...
organization.
    ...
    \hypertarget{a-note-about-vectorization}{%
...
\end{Verbatim}
    ...
    \hypertarget{special-matrix-types}{%
...
\end{Verbatim}
    ...
    \hypertarget{the-uniformscaling-operator}{%
...
could lead to some good performance improvements.
    ...
    \hypertarget{factorization-forms}{%
