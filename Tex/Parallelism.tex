...
\makeatother
    ...
    \hypertarget{levels-of-parallelism}{%
...
\end{itemize}
    ...
    \hypertarget{middle-level-threads}{%
...
\end{itemize}
    ...
    \hypertarget{highest-level-processes-distributed}{%
