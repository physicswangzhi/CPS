...
https://github.com/JuliaDiffEq/DifferentialEquations.jl
    ...
    \hypertarget{basic-through-advanced-video-tutorial-on-github}{%
...
\href{https://www.youtube.com/watch?v=tx8DRc7_c9I}{\includegraphics{https://imgur.com/a/mMRUT}}
...
\item
  ...
  \tightlist
  \item
    Some functionality which used to be in the Base language now exists
    in organization packages
  \end{itemize}
\end{itemize}
...
Checkout the dev branch and use \texttt{plot(...)}).
    ...
    \hypertarget{easter-egg-hunt}{%
\subsection{Easter Egg Hunt}\label{easter-egg-hunt}}

There is an Easter egg hidden in the repository. To find it, checkout
the ``Easter'' branch of the workshop repository
(https://github.com/UCIDataScienceInitiative/IntroToJulia) and use the
commands:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{using} \PY{n}{IntroToJulia}
        \PY{n}{find\PYZus{}easter}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
