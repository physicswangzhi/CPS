...
give it. Looking at the generated code:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{p}{@}\PY{n}{code\PYZus{}llvm} \PY{n}{my\PYZus{}square}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
...
\}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{p}{@}\PY{n}{code\PYZus{}llvm} \PY{n}{my\PYZus{}square}\PY{p}{(}\PY{l+m+mf}{1.0}\PY{p}{)}
\end{Verbatim}
...
That means that
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{n}{my\PYZus{}restricted\PYZus{}square}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}\PY{p}{)} \PY{o}{=} \PY{n}{x}\PY{o}{\PYZca{}}\PY{l+m+mi}{2}
\end{Verbatim}
...
same exact compiled code:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{p}{@}\PY{n}{code\PYZus{}llvm} \PY{n}{my\PYZus{}restricted\PYZus{}square}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}
...
For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{my\PYZus{}number\PYZus{}restricted\PYZus{}square}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{Number}\PY{p}{)} \PY{o}{=} \PY{n}{x}\PY{o}{\PYZca{}}\PY{l+m+mi}{2}
\end{Verbatim}
...
dispatch differently for different type classes. For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{my\PYZus{}number\PYZus{}restricted\PYZus{}square}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractArray}\PY{p}{)} \PY{o}{=} \PY{p}{(}\PY{n}{println}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{;}\PY{n}{x}\PY{o}{.}\PY{o}{\PYZca{}}\PY{l+m+mi}{2}\PY{p}{)}
\end{Verbatim}
...
\texttt{1:10}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{a} \PY{o}{=} \PY{l+m+mi}{1}\PY{p}{:}\PY{l+m+mi}{10}
\end{Verbatim}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n+nb}{typeof}\PY{p}{(}\PY{n}{a}\PY{p}{)} \PY{o}{\PYZlt{}:} \PY{n}{AbstractArray}
\end{Verbatim}
...
created. Creating large arrays can be a costly action:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{p}{@}\PY{n}{time} \PY{n}{collect}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{:}\PY{l+m+mi}{10000000}\PY{p}{)}
\end{Verbatim}
...
matter what those two numbers are:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:} \PY{p}{@}\PY{n}{time} \PY{l+m+mi}{1}\PY{p}{:}\PY{l+m+mi}{10000000}
\end{Verbatim}
...
like an identity matrix without forming an identity matrix.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:} \PY{n}{println}\PY{p}{(}\PY{n}{I}\PY{p}{[}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{]}\PY{p}{)}
         \PY{n}{println}\PY{p}{(}\PY{n}{I}\PY{p}{[}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
behavior. For example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{AbstractPerson} \PY{k}{end}
         \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{AbstractStudent} \PY{o}{\PYZlt{}:} \PY{n}{AbstractPerson} \PY{k}{end}
         \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{AbstractTeacher} \PY{o}{\PYZlt{}:} \PY{n}{AbstractPerson} \PY{k}{end}
         ...
         \PY{n}{mutable} \PY{n}{struct} \PY{n}{Student} \PY{o}{\PYZlt{}:} \PY{n}{AbstractStudent}
           \PY{n}{name}\PY{p}{:}\PY{p}{:}\PY{n}{String}  
           \PY{n}{grade}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}
           \PY{n}{hobby}\PY{p}{:}\PY{p}{:}\PY{n}{String}
         \PY{k}{end}
...
has a name which can be gotten by \texttt{get\_name}''.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{get\PYZus{}name}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractPerson}\PY{p}{)} \PY{o}{=} \PY{n}{x}\PY{o}{.}\PY{n}{name}
\end{Verbatim}
...
action:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}17}]:} \PY{n}{get\PYZus{}name}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{MusicStudent}\PY{p}{)} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Justin Bieber}\PY{l+s}{\PYZdq{}}
\end{Verbatim}
...
codes.
    ...
    \hypertarget{small-functions-and-constant-propagation}{%
...
generally people like music. This means that:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}18}]:} \PY{n}{likes\PYZus{}music}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractTeacher}\PY{p}{)} \PY{o}{=} \PY{n}{false}
         \PY{n}{likes\PYZus{}music}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractStudent}\PY{p}{)} \PY{o}{=} \PY{n}{true}
         \PY{n}{likes\PYZus{}music}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractPerson}\PY{p}{)} \PY{o}{=} \PY{n}{true}
\end{Verbatim}
...
student, they will then double that (impulsive Millenials!).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k}{function}\PY{n+nf}{ }\PY{n+nf}{number\PYZus{}of\PYZus{}records}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractPerson}\PY{p}{)}
             \PY{k}{if} \PY{o}{!}\PY{n}{likes\PYZus{}music}\PY{p}{(}\PY{n}{x}\PY{p}{)} 
               \PY{k}{return} \PY{l+m+mi}{0}
             \PY{k}{end}
             \PY{n}{num\PYZus{}records} \PY{o}{=} \PY{n}{rand}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
             \PY{k}{if} \PY{n+nb}{typeof}\PY{p}{(}\PY{n}{x}\PY{p}{)} \PY{o}{\PYZlt{}:} \PY{n}{AbstractStudent}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{x} \PY{o}{=} \PY{n}{Teacher}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Randy}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+m+mi}{11}\PY{p}{)}
        \PY{n}{println}\PY{p}{(}\PY{n}{number\PYZus{}of\PYZus{}records}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{)}
        \PY{p}{@}\PY{n}{code\PYZus{}llvm} \PY{n}{number\PYZus{}of\PYZus{}records}\PY{p}{(}\PY{n}{x}\PY{p}{)}
\end{Verbatim}
...
music genre types:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{MusicGenres} \PY{k}{end}
         \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{RockGenre} \PY{o}{\PYZlt{}:} \PY{n}{MusicGenres} \PY{k}{end}
...
can have traits like:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{n}{favorite\PYZus{}genre}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractPerson}\PY{p}{)} \PY{o}{=} \PY{n}{ClassicRock}\PY{p}{(}\PY{p}{)}
         \PY{n}{favorite\PYZus{}genre}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{MusicStudent}\PY{p}{)} \PY{o}{=} \PY{n}{Classical}\PY{p}{(}\PY{p}{)}
         \PY{n}{favorite\PYZus{}genre}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{AbstractTeacher}\PY{p}{)} \PY{o}{=} \PY{n}{AltRock}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
allows you to dispatch on a trait \texttt{IsNice} like:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{p}{@}\PY{n}{traitfn} \PY{n}{ft}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{p}{:}\PY{p}{:}\PY{n}{IsNice}\PY{p}{)} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Very nice!}\PY{l+s}{\PYZdq{}}
        \PY{p}{@}\PY{n}{traitfn} \PY{n}{ft}\PY{p}{(}\PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{p}{:}\PY{p}{:}\PY{p}{(}\PY{o}{!}\PY{n}{IsNice}\PY{p}{)}\PY{p}{)} \PY{o}{=} \PY{l+s}{\PYZdq{}}\PY{l+s}{Not so nice!}\PY{l+s}{\PYZdq{}}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{MyType2}
            \PY{n}{mt}\PY{p}{:}\PY{p}{:}\PY{n}{MyType}
            \PY{o}{.}\PY{o}{.}\PY{o}{.} \PY{c}{\PYZsh{} Other stuff}
        \PY{k}{end} 
        
        \PY{n}{f}\PY{p}{(}\PY{n}{mt2}\PY{p}{:}\PY{p}{:}\PY{n}{MyType2}\PY{p}{)} \PY{o}{=} \PY{n}{f}\PY{p}{(}\PY{n}{mt2}\PY{o}{.}\PY{n}{mt}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}25}]:} \PY{k}{macro} \PY{n}{def}\PY{p}{(}\PY{n}{name}\PY{p}{,} \PY{n}{definition}\PY{p}{)}
               \PY{k}{return} \PY{k}{quote}
                   \PY{k}{macro} \PY{o}{\PYZdl{}}\PY{n}{name}\PY{p}{(}\PY{p}{)}
                       \PY{n}{esc}\PY{p}{(}\PY{o}{\PYZdl{}}\PY{p}{(}\PY{n}{Expr}\PY{p}{(}\PY{p}{:}\PY{k}{quote}\PY{p}{,} \PY{n}{definition}\PY{p}{)}\PY{p}{)}\PY{p}{)}
                   \PY{k}{end}
               \PY{k}{end}
           \PY{k}{end}
\end{Verbatim}
...
example:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{p}{@}\PY{n}{def} \PY{n}{give\PYZus{}it\PYZus{}a\PYZus{}name} \PY{k}{begin}
...
Optim.jl's solvers could be put into an \texttt{@def}:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{p}{@}\PY{n}{def} \PY{n}{add\PYZus{}generic\PYZus{}fields} \PY{k}{begin}
                 \PY{n}{method\PYZus{}string}\PY{p}{:}\PY{p}{:}\PY{n}{String}
                 \PY{n}{n}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int64}
                 \PY{n}{x}\PY{p}{:}\PY{p}{:}\PY{n}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
                 \PY{n}{f\PYZus{}x}\PY{p}{:}\PY{p}{:}\PY{n}{T}
                 \PY{n}{f\PYZus{}calls}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int64}
                 \PY{n}{g\PYZus{}calls}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int64}
                 \PY{n}{h\PYZus{}calls}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int64}
         \PY{k}{end}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}28}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{LBFGSState}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
             \PY{p}{@}\PY{n}{add\PYZus{}generic\PYZus{}fields}
             \PY{n}{x\PYZus{}previous}\PY{p}{:}\PY{p}{:}\PY{n}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
             \PY{n}{g}\PY{p}{:}\PY{p}{:}\PY{n}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
             \PY{n}{g\PYZus{}previous}\PY{p}{:}\PY{p}{:}\PY{n}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
             \PY{n}{rho}\PY{p}{:}\PY{p}{:}\PY{n}{Array}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} The abstract type}
        \PY{p}{@}\PY{n}{base} \PY{n}{mutable} \PY{n}{struct} \PY{n}{AbstractFoo}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
            \PY{n}{a}
            \PY{n}{b}\PY{p}{:}\PY{p}{:}\PY{k+kt}{Int}
            \PY{n}{c}\PY{p}{:}\PY{p}{:}\PY{n}{T}
            \PY{n}{d}\PY{p}{:}\PY{p}{:}\PY{n}{Vector}\PY{p}{\PYZob{}}\PY{n}{T}\PY{p}{\PYZcb{}}
        \PY{k}{end}
        
        \PY{c}{\PYZsh{} Inheritance}
        \PY{p}{@}\PY{n}{extend} \PY{n}{mutable} \PY{n}{struct} \PY{n}{Foo} \PY{o}{\PYZlt{}:} \PY{n}{AbstractFoo}
            \PY{n}{e}\PY{p}{:}\PY{p}{:}\PY{n}{T}
        \PY{k}{end}
\end{Verbatim}
