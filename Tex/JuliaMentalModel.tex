...
\end{figure}
    ...
    \hypertarget{syntax-is-familiar}{%
...
{\color{incolor}In [{\color{incolor} }]:} \PY{o}{\PYZpc{}}\PY{n}{BPATH1} \PY{n}{Brownian} \PY{n}{path} \PY{n}{simulation}
        \PY{k}{function}\PY{n+nf}{ }\PY{o}{[}\PY{n}{t}\PY{p}{,}\PY{n}{W}\PY{p}{]}\PY{o}{=}\PY{n}{BPATH1}\PY{p}{(}\PY{n}{T}\PY{p}{,}\PY{n}{N}\PY{p}{)}
        ...
        \PY{n}{dW}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{=} \PY{n}{sqrt}\PY{p}{(}\PY{n}{dt}\PY{p}{)}\PY{o}{*}\PY{n}{randn}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{;}
        \PY{n}{W}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{=} \PY{n}{dW}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{;}
        
        \PY{k}{for} \PY{n}{j} \PY{o}{=} \PY{l+m+mi}{2}\PY{p}{:}\PY{n}{N}
            \PY{n}{dW}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{p}{)} \PY{o}{=} \PY{n}{sqrt}\PY{p}{(}\PY{n}{dt}\PY{p}{)}\PY{o}{*}\PY{n}{randn}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{;}
            \PY{n}{W}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{p}{)} \PY{o}{=} \PY{n}{W}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{)} \PY{o}{+} \PY{n}{dW}\PY{p}{(}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{p}{)}\PY{p}{;}
        \PY{k}{end}
        \PY{n}{t} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{n}{dt}\PY{p}{:}\PY{n}{T}\PY{o}{\PYZhy{}}\PY{n}{dt}\PY{p}{]}\PY{p}{;}
        \PY{k}{end}
        
        \PY{o}{\PYZpc{}} \PY{n}{In} \PY{n}{Another} \PY{n}{File}\PY{o}{.}\PY{o}{.}\PY{o}{.}
        
        \PY{n}{f} \PY{o}{=} \PY{p}{@}\PY{p}{(}\PY{p}{)} \PY{n}{BPATH1}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{10000}\PY{p}{)}\PY{p}{;}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{k}{function}\PY{n+nf}{ }\PY{n+nf}{bpath}\PY{p}{(}\PY{n}{T}\PY{p}{,}\PY{n}{N}\PY{p}{)}
            ...
            \PY{n}{dW}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{n}{sqrt}\PY{p}{(}\PY{n}{dt}\PY{p}{)}\PY{o}{*}\PY{n}{randn}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
            \PY{n}{W}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{=} \PY{n}{dW}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{]}
        
            \PY{k}{for} \PY{n}{j} \PY{o}{=} \PY{l+m+mi}{2}\PY{p}{:}\PY{n}{N}
                \PY{n}{dW}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{p}{]} \PY{o}{.}\PY{o}{=} \PY{n}{sqrt}\PY{p}{(}\PY{n}{dt}\PY{p}{)}\PY{o}{*}\PY{n}{randn}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
                \PY{n}{W}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{p}{]} \PY{o}{.}\PY{o}{=} \PY{n}{W}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{o}{\PYZhy{}}\PY{l+m+mi}{1}\PY{p}{]} \PY{o}{.}\PY{o}{+} \PY{n}{dW}\PY{p}{[}\PY{p}{:}\PY{p}{,}\PY{n}{j}\PY{p}{]}
            \PY{k}{end}
            \PY{p}{[}\PY{l+m+mi}{0}\PY{p}{:}\PY{n}{dt}\PY{p}{:}\PY{n}{T}\PY{o}{\PYZhy{}}\PY{n}{dt}\PY{p}{]}\PY{p}{,}\PY{n}{W}
        \PY{k}{end} \PY{c}{\PYZsh{} Translation took \PYZlt{} 1 minute}
        \PY{p}{@}\PY{n}{time} \PY{n}{t}\PY{p}{,}\PY{n}{W} \PY{o}{=} \PY{n}{bpath}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{100000}\PY{p}{)} \PY{c}{\PYZsh{} Timing is slower in Jupyter!}
        \PY{p}{@}\PY{n}{time} \PY{n}{t}\PY{p}{,}\PY{n}{W} \PY{o}{=} \PY{n}{bpath}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{100000}\PY{p}{)} \PY{c}{\PYZsh{} Timing is slower in Jupyter!}
        \PY{c}{\PYZsh{} 10x speedup over MATLAB}
        \PY{k}{using} \PY{n}{Plots}
        \PY{n}{plot}\PY{p}{(}\PY{n}{t}\PY{p}{,}\PY{n}{W}\PY{o}{\PYZsq{}}\PY{p}{,}\PY{n}{color}\PY{o}{=}\PY{p}{:}\PY{n}{red}\PY{p}{,}\PY{n}{xlabel}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{t}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{n}{ylabel}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s}{W(t)}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
