...
\makeatother
    ...
    \hypertarget{a-basic-introduction-to-julia}{%
...
work at your own pace, or with others if that's how you're comfortable!
    ...
    \hypertarget{documentation-and-hunting}{%
...
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{a} \PY{o}{=} \PY{n}{Vector}\PY{p}{\PYZob{}}\PY{k+kt}{Float64}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)} \PY{c}{\PYZsh{} Create a length 5 Vector (dimension 1 array) of Float64\PYZsq{}s}
         ...
         \PY{n}{c} \PY{o}{=} \PY{n}{Array}\PY{p}{\PYZob{}}\PY{k+kt}{Float64}\PY{p}{\PYZcb{}}\PY{p}{(}\PY{l+m+mi}{4}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{7}\PY{p}{)} \PY{c}{\PYZsh{} Define a (4,5,6,7) array of Float64\PYZsq{}s }
...
disadvantages from named functions.
    ...
    \hypertarget{type-declaration-syntax}{%
...
In Julia, we would define the car type as follows:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{Car}
             \PY{n}{make}
             \PY{n}{model}
         \PY{k}{end}
\end{Verbatim}
...
(defined by :Symbol, which we will go into plenty more detail later).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{WorkshopParticipant}
...
allow this age to be any Number type as follows:
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}1}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{StaffMember}\PY{p}{\PYZob{}}\PY{n}{T}\PY{o}{\PYZlt{}:}\PY{n}{Number}\PY{p}{\PYZcb{}}
            \PY{n}{name}\PY{p}{:}\PY{p}{:}\PY{n}{String}
            \PY{n}{field}\PY{p}{:}\PY{p}{:}\PY{n}{Symbol}
...
keyword
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{Person}
         \PY{k}{end}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{n}{mutable} \PY{n}{struct} \PY{n}{Student} \PY{o}{\PYZlt{}:} \PY{n}{Person}
             \PY{n}{name}
             \PY{n}{grade}
         \PY{k}{end}
\end{Verbatim}
...
http://docs.julialang.org/en/release-0.5/manual/types/\#abstract-types
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{k}{abstract}\PY{n+nc}{ }\PY{n+nc}{type} \PY{n}{AbstractStudent} \PY{o}{\PYZlt{}:} \PY{n}{Person}
         \PY{k}{end}
\end{Verbatim}
...
good performance.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{n}{struct} \PY{n}{Field}
            \PY{n}{name}
            \PY{n}{school}
        \PY{k}{end}
...
\hypertarget{lazy-iterator-types}{%
...
called once (before the function compilation).
    ...
    \hypertarget{steps-for-julia-parsing-and-execution}{%
