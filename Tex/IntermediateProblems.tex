...
\makeatother
    ...
    \hypertarget{intermediate-problems}{%
\section{Intermediate Problems}\label{intermediate-problems}}

\hypertarget{myrange-and-linspace-problem}{%
...
\hypertarget{part-4-advanced}{%
\paragraph{Part 4 (Advanced)}\label{part-4-advanced}}
...
Define a type \texttt{StrangMatrix\ \textless{}:\ AbstractMatrix} and
define a dispatch such that \texttt{A*x} acts like a Strang matrix on a
vector.

\textbf{Bonus: Iterative solvers solve \texttt{Ax=b} and only require
the definition of matrix multiplication. Thus utilize
IterativeSolvers.jl to solve \texttt{Ax=b} for \texttt{b=rand(100)}
using your lazy matrix type. Hint: you will need to define
\texttt{A\_mul\_B!}.}
...
\hypertarget{regression-problem-part-2}{%
...
line using \texttt{abline!}. Add a title saying ``Regression Plot on
Fake Data'', and label the x and y axis.

    \hypertarget{type-hierarchy-problem}{%
...
interacts with the compiler).
    ...
    \hypertarget{distribution-quantile-problem-from-josh-day}{%
